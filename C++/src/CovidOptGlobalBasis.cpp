...
#include "optimizers/OptimizerGlobalBasis.h"
...
main(int argc, char *argv[])
{
  ...
  if (num_basis <= 0)
    throwError("No. of basis functions should be greater than zero.");
  ...
  OptimizerGlobalBasis opt(pop_observed, pop_init, pop_quarantine_input, num_basis,
