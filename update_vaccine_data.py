...
fieldnames = ("Date","Covishield 1","Covishield 2","Sinopharm 1","Sinopharm 2","Sputnik 1","Sputnik 2","Pfizer 1","Pfizer 2","Moderna 1","Moderna 2")
...
for row in csvreader:
    row_sum = {'t': row['Date'], 
               'dose1': (int(row['Covishield 1']) + int(row['Sinopharm 1']) + int(row['Sputnik 1']) + int(row['Pfizer 1']) + int(row['Moderna 1'])),
               'dose2': (int(row['Covishield 2']) + int(row['Sinopharm 2']) + int(row['Sputnik 2']) + int(row['Pfizer 2']) + int(row['Moderna 2']))
              }
